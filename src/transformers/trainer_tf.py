...
from .trainer_utils import PREFIX_CHECKPOINT_DIR, EvalPrediction, PredictionOutput, TimeStrategy, set_seed
            ...
            for epoch_iter in range(epochs_trained, int(epochs)):
                ...
                for step, batch in enumerate(train_ds):
                    ...
                    if (
                        ...
                        and self.args.evaluation_strategy == TimeStrategy.STEPS
