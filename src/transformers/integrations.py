...
from .trainer_utils import PREFIX_CHECKPOINT_DIR, BestRun, TimeStrategy  # noqa: E402
...
def run_hp_search_ray(trainer, n_trials: int, direction: str, **kwargs) -> BestRun:
    ...
    if "scheduler" in kwargs:
        ...
        ) and (not trainer.args.do_eval or trainer.args.evaluation_strategy == TimeStrategy.NO):
            raise RuntimeError(
